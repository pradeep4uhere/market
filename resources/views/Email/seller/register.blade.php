...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; border-top: 1px solid #EDEFF2; border-bottom:  1px solid #EDEFF2; margin-top: 25px; padding-top: 25px; margin-bottom:  25px; ">
      ...
      <tbody><tr valign="top">
        ...
        <td valign="top" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
          ...
          <p>Complete your business details for publish your business account to user. <a href="{{env('APP_URL')}}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">Learn more</a></p>
        </td>
      ...
      <tr valign="top">
        ...
        <td valign="top"  style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
          ...
          <p>Want to sell product in your store, complete your Seller Profile &nbsp;<a href="{{env('APP_URL')}}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">Learn more</a></p>
        </td>
      ...
      <tr valign="top">
        ...
        <td valign="top" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
          ...
          <p>Adding new products is very easy now for your customer &nbsp;<a href="{{env('APP_URL')}}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">Learn more</a></p>
        </td>
...
into your web browser: <a href="{{env('APP_URL')}}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">{{$url}}</a></p>
        </td>
    </tr>
</table>
