        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="wizard-container">
                ...
                <div class="card wizard-card" data-color="orange" id="wizardProfile">
                    ...
                    <form method="POST" action="{{route('becomeseller')}}">
                        {!! csrf_field() !!}
                <!--        You can switch ' data-color="orange" '  with one of the next bright colors: "blue", "green", "orange", "red"          -->
                        ...
                        <div class="wizard-header">
                            ...
                            <p>
                                ...
                                <p class="alert alert-success"><a href="{{route('login')}}">
                                    {{ Session::get('message') }}
                                </a>
                                </p>
                                @endif
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="account">
                                <h4 class="info-text"> What are you ?</h4>
                                <div class="row">

                                    <div class="col-sm-10 col-sm-offset-1">
                                         <div class="form-group">
                                             <label>Your Store Type <small>(required)</small></label><br>
                                             <select name="store_type" class="form-control">
                                                @if(!empty($businessType))
                                                @foreach($businessType as $obj)
                                                <option value="{{$obj['id']}}" @if(!empty($user)) @if(Session::get('store_type')==$obj['id']) {{"selected"}} @endif @endif>
                                                    {{$obj['name']}}
                                                </option>
                                                @endforeach
                                                @endif
                                 ...
                                 <div class="row">
                                  ...
                                  <div class="col-sm-6">
                                      <div class="form-group">
                                        ...
                                        <input name="business_name" type="text" class="form-control" placeholder="Andrew General Store" value={{Session::get('business_name')}}>
                                      </div>
                                      <div class="form-group">
                                        <label>Referer Code <small>(optional)</small></label>
                                        <input name="referer_code" type="text" class="form-control" placeholder="e.g 9B5CED14" value={{Session::get('referer_code')}}>
                                        <small><span id="storeUrl" style="color: #888">You will <a href="#" data-toggle="popover" title="Referer Code" data-placement="top" data-content="You can also refer to somone for getting more benifit of your seller account.** Please conatct at info@go4shop.online"><b>Get Rewards</b></a> if you use valid refer code.
                                        <a href="#" data-toggle="popover" title="Referer Code" data-placement="top" data-content="You can also refer to somone for getting more benifit of your seller account.** Please conatct at info@go4shop.online">?</a>
                                        </span></small>
                                      </div>
                                  </div>
                                  <div class="col-sm-10 col-sm-offset-1">
                                      <div class="form-group">
                                          <label>Business URL <small>(required)</small></label>
                                          <input name="businessusername" type="text" class="form-control" placeholder="www.go4shop.online/seller/{yourbusinessname}" value={{Session::get('businessusername')}}>
                                          <small>Your Page:: <span id="storeUrl" style="color: #888">www.go4shop.online/seller/{yourbusinessname}</span></small>
                                      </div>
                                  </div>
                                  <div class="col-sm-5 col-sm-offset-1">
                                      <div class="form-group">
                                          <label>Business Email <small>(required)</small></label>
                                          <input name="email_address" type="email" class="form-control" placeholder="e.g abc@xyz.com" value={{Session::get('email_address')}}>
                                      </div>
                                   
                                  </div>
                                  <div class="col-sm-5">
                                     <div class="form-group">
                                        <label>Business Mobile No <small>(required)</small></label>
                                        <input name="contact_number" type="text" class="form-control" placeholder="Enter contact_number" value={{Session::get('contact_number')}}>
                                      </div>
                                  </div>
                              </div>
                            </div>
