 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
							...
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url({{config('global.THEME_URL_IMAGE').'/images/'}}1.jpg) no-repeat center"> </span> 
										 <div class="user-name">
				...
				<div class="activity_box">
					...
					<div class="scrollbar scrollbar1" id="style-2">
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='{{config('global.THEME_URL_IMAGE').'/images/'}}1.png' class="img-responsive" alt=""/></div>
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='{{config('global.THEME_URL_IMAGE').'/images/'}}5.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='{{config('global.THEME_URL_IMAGE').'/images/'}}3.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='{{config('global.THEME_URL_IMAGE').'/images/'}}4.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
				...
				<div class="activity_box activity_box1">
					...
					<div class="scrollbar" id="style-2">
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='{{config('global.THEME_URL_IMAGE').'/images/'}}1.png' class="img-responsive" alt=""/><span>10:00 PM</span></div>
						...
						<div class="activity-row activity-row1">
							...
							<div class="col-xs-3 activity-img"><img src='{{config('global.THEME_URL_IMAGE').'/images/'}}3.png' class="img-responsive" alt=""/><span>10:02 PM</span></div>
							<div class="clearfix"> </div>
						</div>
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='{{config('global.THEME_URL_IMAGE').'/images/'}}1.png' class="img-responsive" alt=""/><span>10:00 PM</span></div>
        ...
        <!--footer section start-->
			<footer>
			   <p>&copy 2018 GrabMore Admin Panel. All Rights Reserved | Design by <a href="#" target="_blank">GrabMore.</a></p>
			</footer>
        <!--footer section end-->
