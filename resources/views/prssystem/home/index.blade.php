@extends('prssystem/layouts/master')
@section('title')
    Home Page
@stop
@section('content')
            ...
            <div class="container">
                <div class="row d-md-flex brand">
                    <div class="col-md-6 hidden-sm-down wow fadeIn">
                        <img class="img-fluid mx-auto d-block" src="{{ Config('global.THEME_URL_IMAGE') }}product.png"/>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row d-md-flex mt-5">
                    <div class="col-sm-6 p-0 wow fadeInLeft">
                        <img class="img-fluid" src="{{ Config('global.THEME_URL_IMAGE') }}product2.jpg" alt="Gallery">
                    </div>
            ...
            <div class="container">
                <div class="row d-md-flex text-center wow fadeIn">
                    <div class="col-md-6 offset-md-3 col-sm-10 offset-sm-1 col-xs-12">
                        ...
                        <p class="mt-5">
                            <a href="#" class="mr-2"><img src="{{ Config('global.THEME_URL_IMAGE') }}google-play.png" class="store-img"/></a>
                            <a href="#"><img src="{{ Config('global.THEME_URL_IMAGE') }}apple_store.png" class="store-img"/> </a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row d-md-flex mt-5 text-center">
                    <div class="team col-sm-3 mt-2 wow fadeInLeft">
                        <img src="{{ Config('global.THEME_URL_IMAGE') }}team-1.jpg" alt="Male" class="img-team img-fluid rounded-circle"/>
                        <h5>John Deo</h5>
                        <p>CEO, Comply</p>
                    </div>
                    <div class="team col-sm-3 mt-2 wow fadeIn">
                        <img src="{{ Config('global.THEME_URL_IMAGE') }}team-4.jpg" alt="Male" class="img-team img-fluid rounded-circle"/>
                        <h5>Kathrine Kaif</h5>
                        <p>Marketing Head</p>
                    </div>
                    <div class="team col-sm-3 mt-2 wow fadeIn">
                        <img src="{{ Config('global.THEME_URL_IMAGE') }}team-2.jpg" alt="Male" class="img-team img-fluid rounded-circle"/>
                        <h5>Brandon Lee</h5>
                        <p>Lead Developer</p>
                    </div>
                    <div class="team col-sm-3 mt-2 wow fadeInRight">
                        <img src="{{ Config('global.THEME_URL_IMAGE') }}team-3.jpg" alt="Male" class="img-team img-fluid rounded-circle"/>
                        <h5>Inza Fererri</h5>
                        <p>Customer Care</p>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row d-md-flex mt-5">
                    <div class="col-sm-4 mt-2 wow fadeIn">
                        <div class="card">
                            <img class="card-img-top" src="{{ Config('global.THEME_URL_IMAGE') }}log-1.jpg" alt="Image">
                            <div class="card-body">
                    ...
                    <div class="col-sm-4 mt-2 wow fadeIn">
                        <div class="card">
                            <img class="card-img-top" src="{{ Config('global.THEME_URL_IMAGE') }}blog-2.jpg" alt="Image">
                            <div class="card-body">
                                <p class="card-text text-muted small-xl">
                    ...
                    <div class="col-sm-4 mt-2 wow fadeIn">
                        <div class="card">
                            <img class="card-img-top" src="{{ Config('global.THEME_URL_IMAGE') }}blog-3.jpg" alt="Image">
                            <div class="card-body">
                                <p class="card-text text-muted small-xl">
