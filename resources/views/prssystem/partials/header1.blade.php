...
<div class="template-index" style="">
                        ...
                        <div class="row">
                           ...
                           <div id="_desktop_search" class="site-header__search  hidden-lg-down col-md-4">
                              ...
                              <div id="search-container-full" class="search-info collapse">
                                 <form action="https://smartshop-ishi.myshopify.com/search" method="get" class="search-header search search--focus" role="search" style="position: relative;">
                                    <input type="hidden" name="type" value="product">
                                    <input class="search-header__input search__input" type="search" name="q" placeholder="Search Our Catalog" aria-label="Search Our Catalog" autocomplete="off">
                                    <button class="search-header__submit search__submit btn--link" type="submit">
                                    <span class="search-logo"> <i class="material-icons">search</i> </span>
                                    <span class="icon__fallback-text hidden-lg-down">Search</span>
                                    </button>
                                    <ul class="search-results" style="position: absolute; left: 0px; top: 50px; display: none;"></ul>
                                 </form>
                              </div>
                           </div>
            ...
            <div class="navfullwidth">
               <div class="page-width">
                  <div class="row">
                     ...
                     <div id="shopify-section-Ishi_offer" class="shopify-section shopify-section" style="display: block;">
