            ...
            <div class="table-responsive">
                <table id="mytable" class="table table-bordred table-striped">
                    ...
                    <tbody>
                        ...
                        <tr 
                        @if($Obj->order_status=='Complete') style="background-color: lightgreen;" @endif
                        @if($Obj->order_status=='Canceled') style="background-color: red;" @endif>
                            <td>{{$count++}}</td>
                            ...
                            <td>
                                <select  @if($Obj->order_status=='Complete') disabled @endif class="form-control" style="width:120px" onChange="updateStatus(this.value,'{{encrypt($Obj->id)}}')">
